...
public class View_Holder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    TextView textView_MatchNumber, textView_StartTime, textView_LobbyType,
            textView_RadiantID, textView_DireID, matchID_View;
    ...
    public void onClick(View view) {
        ...
        String fullmatchtext = matchID_View.getText().toString();
        ...
        DisplayMatchDetailsFragment displayMatchDetailsFragment = DisplayMatchDetailsFragment.newInstance(matchid);
        fm.beginTransaction().replace(R.id.flContent, displayMatchDetailsFragment).addToBackStack(null).commit();
